...
*	Access to a Go 1.7 development system
...
```
git clone https://github.com/purha/s3-benchmark.git
```

You should see the following files in the s3-benchmark directory.
LICENSE	README.md		s3-benchmark.go
...
```
  ...
  -r string
        Region to user (default "us-east-1")
  -d int
